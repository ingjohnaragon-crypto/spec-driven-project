...
`## 1. Resumen`, `## Contexto de arquitectura`, etc. Do not leave English headers
when the active language is `es`. Keep Vault hook names and `contracts_api` types untranslated.
